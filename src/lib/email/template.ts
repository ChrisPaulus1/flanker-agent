...
const SIGNAL_STYLE: Record<SignalLevel, { color: string; bg: string; label: string }> = {
  high: { color: "#c2410c", bg: "#ffedd5", label: "HIGH SIGNAL" },
  medium: { color: "#1d4ed8", bg: "#dbeafe", label: "MEDIUM SIGNAL" },
  low: { color: "#475569", bg: "#f1f5f9", label: "LOW SIGNAL" },
};
...
<body style="margin:0;padding:0;background:#f1f5f9;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f9;padding:24px 12px;">
    <tr><td align="center">
      <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;width:100%;background:#ffffff;border-radius:12px;border:1px solid #e2e8f0;overflow:hidden;">
        ...
        <tr>
          <td style="padding:20px 28px 0;">
            ...
            <div style="background:#f8fafc;border-left:3px solid #cbd5e1;border-radius:0 6px 6px 0;padding:12px 14px;font:400 14px/1.6 ui-monospace,SFMono-Regular,Menlo,monospace;color:#334155;white-space:pre-wrap;">${notes ? escapeHtml(notes) : "<em style='color:#94a3b8'>The developer published no release notes for this version.</em>"}</div>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:8px 28px 28px;">
            <a href="${escapeHtml(dashboardUrl)}" style="display:inline-block;background:#0f172a;color:#ffffff;text-decoration:none;padding:11px 20px;border-radius:8px;font:600 14px/1 -apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">Open dashboard</a>
        ...
        <tr>
          <td style="padding:14px 28px;background:#f8fafc;border-top:1px solid #e2e8f0;font:400 12px/1.5 -apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#94a3b8;">

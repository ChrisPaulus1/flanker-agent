...
const SIGNAL_STYLE: Record<SignalLevel, { color: string; bg: string; label: string }> = {
  high: { color: "#be3d0f", bg: "#fdeee6", label: "HIGH SIGNAL" },
  medium: { color: "#0a6a70", bg: "#e4f4f5", label: "MEDIUM SIGNAL" },
      ...
      <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;width:100%;background:#ffffff;border-radius:12px;border:1px solid #e1e7f0;overflow:hidden;">
        ...
        <tr>
          <td style="padding:20px 28px 0;">
            ...
            <div style="background:#fbf9f5;border-left:3px solid #0b868e;border-radius:0 6px 6px 0;padding:12px 14px;font:400 14px/1.6 ui-monospace,SFMono-Regular,Menlo,monospace;color:#334155;white-space:pre-wrap;">${notes ? escapeHtml(notes) : "<em style='color:#94a3b8'>The developer published no release notes for this version.</em>"}</div>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:8px 28px 28px;">
            <a href="${escapeHtml(dashboardUrl)}" style="display:inline-block;background:#2b2593;color:#ffffff;text-decoration:none;padding:11px 20px;border-radius:8px;font:600 14px/1 -apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">Open dashboard</a>

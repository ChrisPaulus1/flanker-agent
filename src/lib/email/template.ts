...
const SIGNAL_STYLE: Record<SignalLevel, { color: string; bg: string; label: string }> = {
  high: { color: "#6d28d9", bg: "#f1ecfe", label: "HIGH SIGNAL" },
  medium: { color: "#4338ca", bg: "#eaecfd", label: "MEDIUM SIGNAL" },
  low: { color: "#575269", bg: "#f3f2f7", label: "LOW SIGNAL" },
};
...
export function buildAlertHtml({
  ...
  return `<!doctype html>
<html>
<body style="margin:0;padding:0;background:#f5f4fa;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f5f4fa;padding:24px 12px;">
    <tr><td align="center">
      <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;width:100%;background:#ffffff;border-radius:12px;border:1px solid #e6e3f0;overflow:hidden;">
        ...
        <tr>
          <td style="padding:20px 28px 0;">
            ...
            <div style="background:#faf9fd;border-left:3px solid #c9c2e6;border-radius:0 6px 6px 0;padding:12px 14px;font:400 14px/1.6 ui-monospace,SFMono-Regular,Menlo,monospace;color:#334155;white-space:pre-wrap;">${notes ? escapeHtml(notes) : "<em style='color:#94a3b8'>The developer published no release notes for this version.</em>"}</div>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:24px 28px 0;">
            <div style="border-top:1px solid #e6e3f0;padding-top:20px;">
        ...
        <tr>
          <td style="padding:8px 28px 28px;">
            <a href="${escapeHtml(dashboardUrl)}" style="display:inline-block;background:#6d28d9;color:#ffffff;text-decoration:none;padding:11px 20px;border-radius:8px;font:600 14px/1 -apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">Open dashboard</a>
        ...
        <tr>
          <td style="padding:14px 28px;background:#faf9fd;border-top:1px solid #e6e3f0;font:400 12px/1.5 -apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#94a3b8;">
